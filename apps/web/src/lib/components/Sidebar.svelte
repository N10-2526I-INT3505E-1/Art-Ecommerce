			...
			{#if role === 'manager'}
				...
				<li>
					<a
						href="/manage/users"
						class="flex items-center gap-3 rounded-lg"
						class:active={isActive('/manage/users', page.url.pathname)}
						class:bg-primary={isActive('/manage/users', page.url.pathname)}
						class:text-primary-content={isActive('/manage/users', page.url.pathname)}
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							class="h-5 w-5"
						...
						{#if isActive('/manage/users', page.url.pathname)}
							<svg
								xmlns="http://www.w3.org/2000/svg"
								class="ml-auto h-4 w-4"
								fill="none"
